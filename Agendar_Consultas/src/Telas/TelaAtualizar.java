...
public class TelaAtualizar extends JFrame {
	...
	public TelaAtualizar() {
		...
		JLabel lblAtualiza = new JLabel("Atualizar");
		lblAtualiza.setHorizontalAlignment(SwingConstants.CENTER);
		lblAtualiza.setFont(new Font("Leelawadee", Font.BOLD, 30));
		lblAtualiza.setBounds(98, 0, 140, 44);
		contentPane.add(lblAtualiza);
